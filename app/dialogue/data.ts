...
人类的情感无国界。当我看过你的作品之后再去看注解，发现我的感受和你文字表述有很多相似之处，而且我还注意到表述中出现的「现实主义」「荒诞」「戏剧」这几个词，与我绘画想表达的意图一样，有种「画者」所见略同的感觉。`,
        fr: `La première impression que me donnent tes œuvres, c'est qu'elles possèdent une forte dimension narrative. Elles ne s'arrêtent pas simplement à ce que l'on « voit » : elles invitent le spectateur à imaginer, puis à suivre les « indices » présents dans l'image.
Cela me fait penser à la peinture religieuse traditionnelle européenne, qui raconte des histoires : les personnages, leurs gestes, leurs expressions, ou même certains objets qui semblent sans rapport entre eux peuvent cacher un événement. Je ne connais pas très bien la Bible, mais lorsque je regarde ces peintures, j'y ressens souvent une forte dimension symbolique, comme si quelque chose restait encore à dire au-delà de l'image. Je retrouve dans ton travail cette même sensation d'un récit qui demeure inachevé.
Personnellement, j'ai tendance à penser que la peinture peut être divisée, dans les grandes lignes, en plusieurs catégories. Il y a la peinture narrative, qui raconte des histoires ; la peinture documentaire, comme les natures mortes, les portraits ou les paysages, qui cherche à rendre compte de ce qui est là ; la peinture décorative, faite de formes géométriques ou de motifs qui apportent de la couleur à un espace ; et enfin une peinture plus conceptuelle, qui utilise l'image pour exprimer des idées ou des émotions.
Dans ton travail, je trouve à la fois de la « narration » et de la « pensée ». Tu peins une sorte de « flux de conscience » qui vient de ton propre esprit, tu racontes tes propres histoires, mais les objets figuratifs qui apparaissent dans tes tableaux ont aussi une dimension métaphorique. On voit des personnages, des animaux, des paysages, des objets… et pourtant, on sent toujours qu'ils ne sont pas seulement ce qu'ils semblent être.
Dans la culture chinoise, beaucoup d'expressions idiomatiques, de proverbes populaires ou de simples formules comme « comme on dit… » contiennent des significations très riches. De petites choses peuvent ainsi renfermer de grandes vérités.
Si je regarde L'âne a ses raisons que les sabots ignorent à travers une manière de penser chinoise, on pourrait, au premier niveau, y voir l'idée de « ne pas suivre aveuglément le courant ». D'une manière plus affirmée, cela pourrait évoquer l'expression chinoise « 道不同不相为谋 » : lorsque les chemins et les convictions diffèrent, il n'est pas nécessaire de chercher à avancer ensemble. Et, poussée encore plus loin, cette attitude pourrait presque rejoindre « 曲高和寡 » — plus une musique est exigeante, moins nombreux sont ceux qui peuvent l'accompagner — ou encore « 众人皆醉我独醒 » : tous sont ivres, moi seul reste éveillé.
Les émotions humaines n'ont pas de frontières. Après avoir regardé tes œuvres, puis lu les textes qui les accompagnent, j'ai découvert que beaucoup de mes impressions rejoignaient ce que tu avais toi-même exprimé. J'ai également remarqué dans tes textes les mots « réalisme », « absurde » et « théâtre ». Ce sont précisément des notions qui correspondent aussi à ce que je cherche à exprimer dans ma propre peinture.
Cela m'a donné le sentiment que, d'un peintre à l'autre, malgré nos différences, nous pouvons parfois voir les choses d'une manière étonnamment proche.`,
