...
> = {
  zh: {
    title: "为什么是巴黎臻藏？",
    paragraphs: [
      "巴黎臻藏（Zhen Collection Paris）是一家成立于巴黎的国际文化艺术协会。",
