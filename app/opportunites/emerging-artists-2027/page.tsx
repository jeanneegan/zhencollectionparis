...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "Open call for 24 emerging artists — dialogues, Paris exhibition, gallery recommendations, Paris–Shenzhen residencies. Applications 21 Sep – 20 Dec 2026. · ZCP 2027青年艺术家暨Prix WE奖计划征集。",
});
