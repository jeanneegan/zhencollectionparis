        ...
        {latestEdition && editionArtist && editionWork && editionShopUrl ? (
          <section className={`${cardClass} overflow-hidden`}>
            <div className="md:hidden">
              ...
              {editionWork.image ? (
                <div className="relative mt-6 min-h-[300px] bg-stone-100">
                  <Image
              ...
              <div className="px-4 py-8 text-center">
                ...
                <p
                  className={`${
                    useSerif ? serif.className : ""
                  } mt-4 text-2xl font-normal leading-tight text-[#5a2323]`}
                >
                  {locale === "en" ? (
                    <>
            ...
            <div className="hidden md:grid md:grid-cols-[1.15fr_1fr] md:items-stretch">
              {editionWork.image ? (
