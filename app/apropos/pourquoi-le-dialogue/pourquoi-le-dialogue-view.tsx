    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "艺术，是媒介。",
          "时间，是创造者。",
          "真正值得珍藏的，从来不是一件作品本身，而是它在人与人之间不断生成的共同理解，以及这些理解共同构成的文明记忆。",
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Ce qui mérite vraiment d'être préservé n'est jamais une œuvre en elle-même, mais la compréhension commune qu'elle ne cesse de faire naître entre les êtres humains, ainsi que la mémoire civilisationnelle que ces compréhensions composent ensemble.",
        ],
        accentParagraphs: [4, 5],
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Art is the medium.",
          "Time is the creator.",
          "What truly deserves to be preserved is never a single work in itself, but the shared understanding it continuously brings into being between people, and the civilizational memory that these understandings together constitute.",
        ],
...
export function PourquoiLeDialogueView() {
