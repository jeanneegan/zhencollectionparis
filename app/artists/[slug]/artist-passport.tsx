...
> = {
  zh: {
    ...
    collectionQuestions: "Questions · Zhen Collection Paris｜ZCP 的提问",
    ...
    collectionNote:
      "关于该艺术家的咨询与合作 · Inquiry and collaboration regarding this artist",
  ...
  en: {
    ...
    collectionNote: "Inquiry and collaboration regarding this artist",
