...
export type ArtistProfile = {
  ...
  artworks: {
    ...
    titleDisplay?: "locale";
    /** Extra constraints for passport image frame on desktop. */
    passportImageStyle?: {
      maxWidth?: string;
      maxHeight?: string;
      marginInline?: "auto";
...
const suHong: ArtistProfile = {
  ...
  introVideoPoster: "/artists/su-hong/intro-poster.jpg",
  tagline: {
...
If blue-and-white is a visual sign, each traditional motif painted on a porcelain shard is a more intense emotional sign: « every pattern holds meaning, and meaning brings blessing ». The « Blue and White » series carries a spiritual longing for a good life.`,
  ...
  artworks: [
    ...
    },
    {
      ...
      dimensions: "100 × 120 cm",
      image: "/artists/su-hong/works/big-friends-3.jpg",
      imageAspect: [836, 1024],
      seriesId: "big-friends",
      layoutPair: { group: "big-friends-last", role: "main", equal: true },
    },
    {
      id: "20",
      title: { zh: "Big Friends", fr: "Big Friends", en: "Big Friends" },
      ...
      image: "/artists/su-hong/works/big-friends-4.jpg",
      imageAspect: [1024, 755],
      seriesId: "big-friends",
      layoutPair: { group: "big-friends-last", role: "side", equal: true },
    },
    {
      id: "6",
      title: {
...
const elaineErlanWang: ArtistProfile = {
  ...
  practice: {
    zh: "绘画 · 漫画 · 数字绘画",
    fr: "Peinture · Bande dessinée · Peinture numérique",
    en: "Painting · Comics · Digital painting",
  },
...
Her works combine kinetic energy and emotional intensity. Technique, composition, and concept build a layered inner world rendered in unflinching Expressionism. Starting from observations of human connection, she moves toward existential themes: blurred bodies, fragmented limbs, fluid brushwork, and stacked textures express distortion and conflict, yet fuse into a coherent pictorial space — viscous and razor-sharp.`,
  ...
  exhibitions: [
    ...
    },
    {
      ...
      title: {
        zh: "SCOPE 视界国际驻地计划",
        fr: "SCOPE International Artist Residency Program",
        en: "SCOPE International Artist Residency Program",
      },
      venue: "四季艺术汇",
      city: { zh: "佛山", fr: "Foshan", en: "Foshan" },
      type: "group",
    ...
    },
    {
      ...
      title: {
        zh: "100+ 亚洲艺术季",
        fr: "100+ Asia Art Season",
        en: "100+ Asia Art Season",
      },
      venue: "布吉文体中心",
      city: { zh: "深圳", fr: "Shenzhen", en: "Shenzhen" },
      type: "group",
    ...
    },
    {
      year: 2023,
      title: {
        zh: "交互的未来 — 第三届深港澳青年艺术家作品展",
        fr: "Future of Interaction — 3rd Shenzhen, Hong Kong and Macao Young Artists Exhibition",
        en: "Future of Interaction — 3rd Shenzhen, Hong Kong and Macao Young Artists Exhibition",
      },
      venue: "罗湖美术馆",
      city: { zh: "深圳", fr: "Shenzhen", en: "Shenzhen" },
      type: "group",
    },
    {
      year: 2022,
      title: {
        zh: "交互的未来 — 第二届深港澳青年艺术家作品展",
        fr: "Future of Interaction — 2nd Shenzhen, Hong Kong and Macao Young Artists Exhibition",
        en: "Future of Interaction — 2nd Shenzhen, Hong Kong and Macao Young Artists Exhibition",
      },
      venue: "罗湖美术馆",
      city: { zh: "深圳", fr: "Shenzhen", en: "Shenzhen" },
      type: "group",
    },
    {
      ...
      title: {
        zh: "第九届深圳国际艺术博览会",
        fr: "The 9th Shenzhen International Art Fair",
        en: "The 9th Shenzhen International Art Fair",
      },
      venue: "会展中心",
      city: { zh: "深圳", fr: "Shenzhen", en: "Shenzhen" },
      type: "group",
    },
    {
      ...
      title: {
        zh: "绿腮人体 — 系列主题展",
        fr: "Green-Cheek Human — theme exhibition",
        en: "Green-Cheek Human — theme exhibition",
      },
      venue: "立梵艺术空间",
      city: { zh: "深圳", fr: "Shenzhen", en: "Shenzhen" },
      type: "group",
    },
    {
      ...
      title: {
        zh: "第七届深港城市 / 建筑双城双年展",
        fr: "7th Bi-City Biennale of Urbanism / Architecture",
        en: "7th Bi-City Biennale of Urbanism / Architecture",
      },
      venue: "满京华国际艺展中心",
      city: { zh: "深圳", fr: "Shenzhen", en: "Shenzhen" },
      type: "group",
    },
    {
      ...
      title: {
        zh: "第八届深圳国际艺术博览会",
        fr: "The 8th Shenzhen International Art Fair",
        en: "The 8th Shenzhen International Art Fair",
      },
      venue: "会展中心",
      city: { zh: "深圳", fr: "Shenzhen", en: "Shenzhen" },
      type: "group",
    },
    {
      year: 2019,
      title: {
        zh: "第五届「未知的亚洲」日本大阪亚洲艺术博览会",
        fr: "UNKNOWN ASIA Art Exchange Osaka 2019",
        en: "UNKNOWN ASIA Art Exchange Osaka 2019",
      },
      venue: "HERBIS HALL",
    ...
    },
    {
      ...
      title: {
        zh: "深港设计双城展",
        fr: "SZ–HK Design Twin Cities Co-Camp",
        en: "SZ–HK Design Twin Cities Co-Camp",
      },
      venue: "华侨城创意园",
      city: { zh: "深圳", fr: "Shenzhen", en: "Shenzhen" },
      type: "group",
